...
CLASS_NAMES = _FALLBACK_CLASS_NAMES  # replaced with real values once model/indices load


def _load_class_names():
    """Load class order from class_indices.json so labels always match
    whatever model.h5 is actually loaded."""
...
DISEASE_INFO = {
    ...
    "Apple___Black_rot": {"type": "🍎 Fungal Disease", "severity": "High",
    ...
    "Apple___Cedar_apple_rust": {"type": "🍎 Fungal Disease", "severity": "Medium",
    ...
    "Apple___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Blueberry___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Cherry_(including_sour)___Powdery_mildew": {"type": "🍒 Fungal Disease", "severity": "Medium",
    ...
    "Cherry_(including_sour)___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Corn_(maize)___Cercospora_leaf_spot": {"type": "🌽 Fungal Disease", "severity": "Medium",
    ...
    "Corn_(maize)___Common_rust_": {"type": "🌽 Fungal Disease", "severity": "Medium",
    ...
    "Corn_(maize)___Northern_Leaf_Blight": {"type": "🌽 Fungal Disease", "severity": "High",
    ...
    "Corn_(maize)___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Grape___Black_rot": {"type": "🍇 Fungal Disease", "severity": "High",
        ...
        "organic": "Bordeaux mixture (1%) spray"},
    "Grape___Esca_(Black_Measles)": {"type": "🍇 Wood Disease", "severity": "High",
    ...
    "Grape___Leaf_blight_(Isariopsis_Leaf_Spot)": {"type": "🍇 Fungal Disease", "severity": "Medium",
    ...
    "Grape___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Orange___Haunglongbing_(Citrus_greening)": {"type": "🍊 Bacterial Disease", "severity": "Critical",
    ...
    "Peach___Bacterial_spot": {"type": "🍑 Bacterial Disease", "severity": "High",
    ...
    "Peach___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Pepper,_bell___Bacterial_spot": {"type": "🫑 Bacterial Disease", "severity": "High",
    ...
    "Pepper,_bell___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Potato___Early_blight": {"type": "🥔 Fungal Disease", "severity": "Medium",
    ...
    "Potato___Late_blight": {"type": "🥔 Fungal Disease", "severity": "Critical",
    ...
    "Potato___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Raspberry___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Soybean___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Squash___Powdery_mildew": {"type": "🎃 Fungal Disease", "severity": "Medium",
    ...
    "Strawberry___Leaf_scorch": {"type": "🍓 Fungal Disease", "severity": "Medium",
    ...
    "Strawberry___healthy": {"type": "✅ Healthy", "severity": "None",
    ...
    "Tomato___Bacterial_spot": {"type": "🍅 Bacterial Disease", "severity": "High",
    ...
    "Tomato___Early_blight": {"type": "🍅 Fungal Disease", "severity": "Medium",
    ...
    "Tomato___Late_blight": {"type": "🍅 Fungal Disease", "severity": "Critical",
    ...
    "Tomato___Leaf_Mold": {"type": "🍅 Fungal Disease", "severity": "Medium",
    ...
    "Tomato___Septoria_leaf_spot": {"type": "🍅 Fungal Disease", "severity": "Medium",
    ...
    "Tomato___Spider_mites Two-spotted_spider_mite": {"type": "🍅 Pest Infestation", "severity": "High",
    ...
    "Tomato___Target_Spot": {"type": "🍅 Fungal Disease", "severity": "Medium",
    ...
    "Tomato___Tomato_Yellow_Leaf_Curl_Virus": {"type": "🍅 Viral Disease", "severity": "Critical",
    ...
    "Tomato___Tomato_mosaic_virus": {"type": "🍅 Viral Disease", "severity": "High",
    ...
    "Tomato___healthy": {"type": "✅ Healthy", "severity": "None",
